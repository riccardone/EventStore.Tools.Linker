...
public class BufferedEvent : IComparable<BufferedEvent>
{
    ...
    public LinkerEventData EventData { get; }
    public DateTime Created { get; }

    public BufferedEvent(string streamId, long eventNumber, Position originalPosition, LinkerEventData eventData, DateTime created)
    {
        StreamId = streamId;
